...
Public Class NewAdminAdd
    ...
    Private Sub NewAdminAdd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        RD12.Checked = True
        RD22.Checked = True
        RD32.Checked = True
        RD42.Checked = True
        ...
        Else
            ...
            UPDATE vehicle_info, applicant, registrar, emission, form
                ...
                and form.EMM_CODE=emission.EMM_CODE and form.BRANCH_CODE=registrar.BRANCH_CODE;   "
                    ...
                    End Try
                Else
                    MessageBox.Show("The Car is already Registered")
                End If
            Else
    ...
    Private Sub TBCheck()
        If String.IsNullOrEmpty(USERNAME.Text) = True Then
